...
x = "Qwen3-32B_mmlu"
y = "resnet34_Imagenet"
parser.add_argument("--datasets", type=str, default=x)
...
parser.add_argument("--alpha", default=0.05, type=float, help="FDR threshold q. here it is the risk function")
delta = 0.1
...
for i, ds in enumerate(ds_list):
    ...
    for j in range(num_trials):
        ...
        kappa = confidence
        residuals = Yhat != Y
        [theta, b_star], test_risk, test_power, selection_size = bound_cal.bound(args.alpha, delta, kappa, residuals)
        fdr_list.append(test_risk)
