...
total_fdr_list = []
ds1 = "Qwen3-8B_medmcqa"
ds2 = "Qwen3-32B_medmcqa"
ds3 = "Llama-3.1-70B-Instruct_medmcqa"

#ds1 = "s1.1-32B_medmcqa"
#ds2 = "Qwen3-32B_medmcqa"
#ds3 = "SKY-T1-32B-Flash_medmcqa"
...
for _ in range(100):
    ...
    Y = data1["Y"].to_numpy()
    confidence_1 = data1["confidence"].to_numpy()
    Yhat_1 = data1["Yhat"].to_numpy()

    data2 = pd.read_csv("./datasets/" + "Qwen3-32B_medmcqa.csv")
    data2 = data2.iloc[shuffle_indices]
    confidence_2 = data2["confidence"].to_numpy()
    Yhat_2 = data2["Yhat"].to_numpy()

    data3 = pd.read_csv("./datasets/" + "Llama-3.1-70B-Instruct_medmcqa.csv")
    data3 = data3.iloc[shuffle_indices]
    Y3 = data3["Y"].to_numpy()
    confidence_3 = data3["confidence"].to_numpy()
    Yhat_3 = data3["Yhat"].to_numpy()
