    ...
    if args.dataset == "mathqa":
        ...
        for subject in _SUBJECTS:
            dataset_i = load_dataset("parquet", data_files={
                'test': f"/mnt/sharedata/ssd_large/users/huanghp/mmlu/{subject}/test*.parquet",
                'validation': f"/mnt/sharedata/ssd_large/users/huanghp/mmlu/{subject}/validation*.parquet"
            })
