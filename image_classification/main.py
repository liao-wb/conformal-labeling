...
elif args.dataset == "imagenetc2":
    val_dir = "/mnt/sharedata/ssd_small/common/datasets/imagenet-corruption/brightness/2"
    val_tf = transforms.Compose([
        transforms.Resize(256),
        transforms.CenterCrop(224),
        transforms.ToTensor(),
...
elif args.dataset == "imagenetc3":
    val_dir = "/mnt/sharedata/ssd_small/common/datasets/imagenet-corruption/brightness/3"
    val_tf = transforms.Compose([
        transforms.Resize(256),
        transforms.CenterCrop(224),
        transforms.ToTensor(),
...
elif args.dataset == "imagenetc4":
    val_dir = "/mnt/sharedata/ssd_small/common/datasets/imagenet-corruption/brightness/4"
    val_tf = transforms.Compose([
        transforms.Resize(256),
        transforms.CenterCrop(224),
        transforms.ToTensor(),
...
elif args.dataset == "imagenetc5":
    val_dir = "/mnt/sharedata/ssd_small/common/datasets/imagenet-corruption/brightness/5"
    val_tf = transforms.Compose([
        transforms.Resize(256),
        transforms.CenterCrop(224),
        transforms.ToTensor(),
