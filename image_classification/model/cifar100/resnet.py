...
class ResNetCos(nn.Module):
    ...
    def __init__(self, block, num_block, num_classes=100):
        ...
        self.fc_scale = nn.Linear(512 * block.expansion, 1)
    ...
    def forward(self, x):
        ...
        scale = torch.exp(self.bn_scale(self.fc_scale(output)))
        x_norm = F.normalize(output)
...
def resnet18Cos():
    ...
    """
    return ResNetCos(BasicBlock, [2, 2, 2, 2])
